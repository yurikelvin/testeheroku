...
public class FornecedorFilter extends GenericFilterBean {

    private static final String SOMENTE_CLIENTES = "Desculpe, somente fornecedores podem acessar esse recurso.";
